    ...
    describe('Client', () =>{
        ...
        describe('routing', () =>{
            ...
            it('Makes the route available when using defineRoute', () =>{
                ...
                defineRoute({path: '/testFakeRoute', title: 'Report Pal', callback: output =>{
                    updateState({
                        showContact: true
                    })
                }})
        ...
        describe('initial data with router property to be available', () =>{
        ...
        describe('initial data injects router when its not there to start with', () =>{
